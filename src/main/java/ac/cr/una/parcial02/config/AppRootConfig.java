...
@ComponentScans(value = {
        @ComponentScan("ac.cr.una.parcial02.dao"),
        @ComponentScan("ac.cr.una.parcial02.service")
})
public class AppRootConfig {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setAnnotatedClasses(User.class, Role.class, UserLoginHistory.class);
        return factoryBean;
    }
